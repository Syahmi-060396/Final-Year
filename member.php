...
<html>
	...
	<body>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					<h1><span> Welcome Back <?php echo $_SESSION['username']; ?>! </span>
                    <br> view package</h1>
					<ul class="actions">
						<li><a href="upackage.php" class="button alt">View</a></li>
					</ul>
				</div>
			</section>
