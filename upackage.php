	...
	<body>
		...
		<!-- One -->
			<section id="one">
				<div class="inner">
					<header>
						<h2 style="color:black;">PACKAGE LIST</h2>
					</header>
                    <center>
                    <table>
                    <tr>
                    ...
                    <td>
                      Name:GOLD <br> 
                        PRICE:RM 21 000 <br>
                        CAPACITY:1000 PERSON<br><br>
                    </td> 
                    <td>
                        Name: NORMAL <br>
                        PRICE:RM 10 000<br>
                        CAPACITY:500 PERSON<br><br>
                    </td>
                    </tr>
                    <tr>
                    <td><a class="btntmp" href="gold.php" style="background-color:white; color:black; border-style: solid; border-width:2px; border-color:black;padding:10px;">DETAILS</a></td>  
                    <td><a class="btntmp" href="" style="background-color:white; color:black; border-style: solid; border-width:2px; border-color:black;padding:10px;">DETAILS</a></td>
                    </tr>
                    </table>
                    </center>
				</div>
